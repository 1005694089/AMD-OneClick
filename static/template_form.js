...
(function () {
  ...
  function TemplateFormFields(props) {
    ...
    return e(React.Fragment, null,
      ...
      e(Form.Item, { name: 'model_mount', label: 'Model Directory', initialValue: '', tooltip: 'Mount a shared workshop model directory inside the instance. Normal users get read-only access; editors get read-write.' },
        e(Select, { options: [{ value: '', label: 'None' }, { value: 'comfyui', label: 'ComfyUI' }, { value: 'openclaw', label: 'Openclaw' }] })),
